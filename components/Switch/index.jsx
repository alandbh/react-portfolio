    ...
    return (
        <>
            <div className="wrapper flex border border-white/60 h-8 rounded-full relative">
                <div
                    className={`bubble z-0 transition duration-200 bg-white/60 rounded-full top-[2px] h-[26px] absolute ${classObj[option]}`}
                ></div>
                <div className="container flex w-64 justify-between items-center font-bold z-10  text-xs leading-8 uppercase text-white/60">
                    <label className="flex items-center justify-center grow cursor-pointer">
                        <input
                            type="radio"
                            className="sr-only"
                            name="worktype"
                        ...
                        <span
                            className={
                                option === "all" ? "text-color-base/100" : ""
                            }
                        >
                            All
                        </span>
                    ...
                    <label className="flex items-center justify-center grow cursor-pointer">
                        ...
                        <span
                            className={
                                option === "front" ? "text-color-base/100" : ""
                            }
                        >
                            Front-end
                        </span>
