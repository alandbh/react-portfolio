    ...
    sections: [
        {
            title: "My role",
            text: [
                `My job was to do a wide spectrum audit in order to rise some oportunity areas that leads to ideas for the interface.`,
                `I also did some low-fi prototypes and wireframes to reflect the ideas.`,
            ],
            image: "port-sec1-pwc.svg",
        ...
        },
        {
            ...
            image: "port-sec3-pwc.webm",
            bg_color_class: "bg-white",
            video_classname: "w-[100%]",
        },
        {
            title: "Shaping ideias",
            text: [
                `Low-fi prototypes to shape the oportunities rased after the Landscape Audit. `,
            ],
            image: "port-sec4-pwc.png",
